...
function DodajNovuKnjigu({ handleDodaj, duzinaNiza }) {
  ...
  function handleInput(e) {
    let novaKnjiga = userData;
    novaKnjiga[e.target.name] = e.target.value;

    setUserData(novaKnjiga);
  }
  ...
  return (
    <div className="page-wrapper pozadina-gr p-t-30 p-b-30">
      <div className="cont-black">
        <h2 className="title">DODAJ NOVU KNJIGU</h2>
...
export default DodajNovuKnjigu;